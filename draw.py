...
class PolygonDrawer(object):
    ...
    def run(self):
        ...
        img = cv2.resize(cv2.imread("static/inputframe00.jpg"), (1280, 720))
...
if __name__ == "__main__":
    drawer = PolygonDrawer("Polygon")
    image = drawer.run()
    cv2.imwrite("static/outputframe00.jpg", image)
    # print("Polygon = %s" % drawer.points)